...
public class MouseListenerProfesori extends MouseAdapter {
	...
	public void mouseClicked(MouseEvent event) {
		...
		if (column == 3) { // prikazi
			JDialog predmeti = new ModalniDijalog(MainFrame.getInstance(), "Predmeti", true);
		...
		if (column == 4) { // info
			...
			JDialog predmeti = new ModalniDijalog(MainFrame.getInstance(), "Informacije o profesorima", true);
